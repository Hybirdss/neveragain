...
export const CAMERA = {
  ...
  PAN_DURATION_GENTLE_MS: 1500,
  PAN_DURATION_FAST_MS: 1000,
  PAN_DURATION_DRAMATIC_MS: 2000,
  HOLD_DURATION_M7_MS: 5000,
  PULLBACK_DURATION_MS: 3000,
