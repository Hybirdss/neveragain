...
/**
 * Hold for durationMs while slowly drifting heading.
 * Prevents "freeze frame" feel during static holds.
 */
function holdWithDrift(
  ...
  return new Promise((resolve) => {
    ...
    function tick(): void {
      ...
      // Apply micro heading drift
      viewer.scene.camera.rotate(
        Cesium.Cartesian3.UNIT_Z,
        -Cesium.Math.toRadians(driftDegPerSec * dt),
      );
